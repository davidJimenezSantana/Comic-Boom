    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarScroll">
            <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                <li class="nav-item">
                    <a class="nav-link active btn-salir" aria-current="page" href="index.php?pid=<?php echo base64_encode('vista/administrador/inicioAdmin.php') ?>">Inicio</a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link active btn-salir" aria-current="page" href="#">
